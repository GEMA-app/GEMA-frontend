...
const MENU_SECTIONS: MenuSection[] = [
  {
    ...
    items: [
      { icon: LayoutDashboard, label: 'Dashboard', href: '/dashboard', roles: ['todos'] },
      {
        ...
        label: 'Activos',
        href: '/activos',
        roles: ['administrador', 'supervisor-activos', 'supervisor-operaciones'],
      },
      { icon: Wrench, label: 'Mantenimiento', href: '/mantenimiento', roles: ['administrador', 'supervisor-activos', 'supervisor-operaciones', 'tecnico', 'consultor'] },
      {
        icon: BookOpen,
        label: 'Catálogo',
        href: '/catalogo',
  ...
  },
  {
    ...
    items: [
      { icon: Boxes, label: 'Inventario', href: '/inventario', roles: ['administrador', 'almacenista'] },
      {
        ...
        label: 'Ubicaciones',
        href: '/ubicaciones',
        roles: ['administrador', 'supervisor-activos'],
      },
