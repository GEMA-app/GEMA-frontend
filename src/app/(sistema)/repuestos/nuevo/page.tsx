...
export default function NuevoRepuestoPage() {
  ...
  const [articulosError, setArticulosError] = useState<string | null>(null);
  ...
  useEffect(() => {
    getArticulos().then(setArticulos).catch(() => setArticulosError('Error al cargar catálogo de artículos.'));
  }, []);
