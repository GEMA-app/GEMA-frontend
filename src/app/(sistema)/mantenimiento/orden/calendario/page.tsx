...
import gemaApi from '../../../../../lib/gemaApi';
...
export default function CalendarPage() {
  ...
  const handleSchedule = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      await gemaApi.createOrden(empresaId, {
      ...
      setSubmissionMessage(`Orden agendada correctamente para ${scheduledDate} a las ${scheduledTime}.`);
    } catch (err: any) {
      ...
      <div className="mx-auto max-w-4xl rounded-3xl bg-white border border-gray-100 p-10 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <button
              type="button"
              className="rounded-full bg-[#F3D58D] px-8 py-3.5 text-base font-semibold text-[#000000] shadow-[0_4px_12px_rgba(0,0,0,0.08)]"
            >
              Cancelar
            </button>
            <button
